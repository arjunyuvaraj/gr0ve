    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          // Calendar Widget - Single ValueListenableBuilder for efficiency
          ValueListenableBuilder<int>(
            valueListenable: CalendarService.eventsVersion,
            builder: (context, version, _) {
              return Container(
                key: ValueKey('calendar_$version'),
          ...
          // Events List - Single ValueListenableBuilder for efficiency
          Expanded(
            child: ValueListenableBuilder<int>(
              valueListenable: CalendarService.eventsVersion,
              builder: (context, version, _) {
                final selectedDate = _selectedDay ?? _focusedDay;
                final events = CalendarService.getEventsForDate(selectedDate);
                ...
                return ListView.builder(
                  key: ValueKey(
                    'events_list_${version}_${selectedDate.toIso8601String()}',
                  ),
